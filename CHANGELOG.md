...
### Added
- Auto-compact: sends /compact when session tokens exceed 50K threshold
- Token counters reset after successful compact
- Infinite loop prevention (won't compact a /compact response)
