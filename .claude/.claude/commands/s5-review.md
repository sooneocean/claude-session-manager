---
description: "S5 Code Review — 驗證實作是否符合 Spec"
...
R1~R3 完成後，依審查結果寫入不同的 checkpoint node：

**Pass**：
- node-{NNN}-s5-review-pass.md
- Conclusion: "Code review passed. Score: {N}/100."
- Next Input: Test scope (changed files list), acceptance criteria reference. "Proceed to S6 testing."
- Gate: Result=passed, Next Stage=S6

**P1 Fix Required**：
- node-{NNN}-s5-review-p1.md
- Conclusion: "Code review: fix required. {N} P1 blocking issues. Loop {M}/3."
- Next Input: blocking_fixes list (issue ID + file + description). "Return to S4, fix these issues."
- Gate: Result=fix_required, Next Stage=S4

**P0 Redesign Required**：
- node-{NNN}-s5-review-p0.md
- Conclusion: "Code review: redesign required. {N} P0 issues."
- Next Input: P0 issue descriptions. "Return to S1 for redesign."
- Gate: Result=redesign_required, Next Stage=S1

Write order: node → CURRENT → sdd_context.
